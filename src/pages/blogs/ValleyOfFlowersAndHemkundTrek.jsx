...
const ValleyOfFlowersAndHemkundTrek = () => {
  return (
    <>
      <Helmet>
        <title>
          Journey to Valley of Flowers and Hemkund Sahib -The Mansoon Trek |
      ...
      <section className="second-blog-style blog-single py-5">
        <div className="container py-md-5 py-4">
          <div className="right-blog-single pl-lg-5 mb-md-0 mb-5">
            ...
            <h3 className="article-subheading">How It Started</h3>
            <br />
            <p className="sub-para">
            ...
            <p className="sub-para">
              ...
              <b>Trip My Soul</b> who organizes these treks. Called up some
              friends, convinced them (bahut mehnat lagi bhai), and we booked
            ...
            <table className="table table-striped table-hover days-navigation">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="#chapter1">
                      Day 0: Delhi Darshan & The Dramatic Bus Journey 😂
                    </a>
                  </td>
                </tr>
                <tr>
            ...
            <div className="content" id="chapter1">
              ...
              <p className="sub-para">
                <strong>July 19-20, 2025</strong> <br />
                Trip toh start ho gayi but proper adventure toh Delhi se hi
                shuru ho gaya!
              </p>{" "}
              <p className="sub-para">
              ...
              <h3 className="article-subheading"> Delhi Mein Time Pass</h3>
              <p className="sub-para">
                First plan was Red Fort. Reached there full excited and...{" "}
              ...
              <p className="sub-para">
                Someone suggested "Lotus Temple chalte hain" so we took the
                metro. Reached Kalkaji station and guess what?{" "}
                <strong>
                  5:50 PM ho gaya tha and Lotus Temple closes at 6 PM.
                </strong>{" "}
                😭
              </p>
              <p className="sub-para">
              ...
              <p className="sub-para">
                Because of <strong>Kanwar Yatra</strong>, they changed the
                route. Instead of going via Haridwar, bus was now going via
                Saharanpur and Dehradun. Okay fine, route change ho gaya,
                chalega.
              </p>
              <p className="sub-para">
              ...
              <p className="sub-para">
                Guess what he said?{" "}
                <strong>
                  "Do log bus miss kar gaye hain. Woh cab se aa rahe hain. Unka
                  wait kar rahe hain."
                </strong>{" "}
                I was like WHAT?! 😡 We have to reach Rishikesh by 7 AM! Our
                travel agent is waiting! And you're making 40+ people wait for 2
                people who missed the bus??
              </p>
              <h3 className="article-subheading">
                {" "}
                The Girl Who Became Everyone's Hero 😂
              </h3>
              <p className="sub-para">
                I came back and told Shubham about this. There were two girls
                sitting below our seat. They overheard and asked what's
                happening. I explained the whole situation.
              </p>
              <p className="sub-para">Bhai, that girl was FIRE. 🔥</p>
              <p className="sub-para">
                She immediately got off the bus and started arguing with the bus
                operators. Full loud, full dramatic, full Bollywood style. We
                were all watching from the windows like it's live entertainment.
              </p>
              <p className="sub-para">
              ...
              <p className="sub-para">
                <strong>
                  "We waited 2-3 hours for you! We missed our schedule! Who's
                  going to pay for this? Give everyone ₹10,000 compensation!"
                </strong>
              </p>
              <p className="sub-para">
                And so much more nonsense. But honestly? We were all enjoying.
                Nobody stopped her. Free entertainment chal raha tha. 😂
              </p>
              <p className="sub-para">
                The best part? Those people were relatives of some DSP in Delhi.
                They even called the police! But that girl didn't budge. After
                another 30 minutes of drama, the bus finally left...{" "}
                <strong>without them.</strong>. We wasted another 30 minutes for
                nothing, It seems like she loved the attention too much. or
                maybe she was fraustraed with any other thing. Who knows!
              </p>
              <p className="sub-para">
                I don't know if I should feel bad or impressed. But it was PEAK
                bus travel drama.
              </p>
              <h3 className="article-subheading"> Finally, Rishikesh!</h3>
              <p className="sub-para">
                We reached Nepali Farm area in Rishikesh around 9 AM. Took a
                taxi to the pickup point where Dev and Reegesh were already
                waiting with the car. They were part of our Trip My Soul batch,
                so now we were a group of 6.
              </p>
              <p className="sub-para">
              ...
              <p className="sub-para">
                We went to our rooms and crashed. Need full energy for tomorrow!
                💤
              </p>
            </div>
            <div className="content" id="chapter2">
              ...
              <p className="sub-para">
                We packed our bags, keeping only essentials. Baaki kapde aur
                saman hotel mein hi chhod diye. No point carrying extra weight
                for 3 days.
              </p>
              <p className="sub-para">
              ...
              <p className="sub-para">
                I was recording everything on my{" "}
                <strong>DJI Action Camera in 4K</strong> 📹 Memories ban rahe
                the real-time mein!
              </p>
              <p className="sub-para">
                The path goes alongside the Pushpawati River, through forests,
                over small bridges, past mule trains carrying supplies. It's not
                super difficult but it's long and continuous uphill. Your legs
                start feeling it after a while.
              </p>
              ...
              <p className="sub-para">
                ...
                <strong> Samosa with Chole </strong> &{" "}
                <strong>Kadahi Doodh</strong> - Mat lena bhai Kabhi, Garam Garam
                Pani tha Do chammach Doodh ke sath 😂
              </p>
              <p className="sub-para">
            ...
            <div className="content" id="chapter3">
              ...
              <p className="sub-para">
                Light rain ho rahi thi, so we wore raincoats. But after some
                time, rain stopped. Good timing!
              </p>
              <h3 className="article-subheading">
                {" "}
              ...
              <p className="sub-para">
                Should I go back? One local uncle said "No need for Valley of
                Flowers. You're young, you'll manage." I asked Suraj Bhaiya as
              ...
              <p className="sub-para">
                Initial 200 meters had jungle on both sides. We could already
              ...
              <p className="sub-para">
                ...
                Memories ban rahe hain real-time mein!
              </p>
              <h3 className="article-subheading"> Suraj Bhaiya's Sarcasm 😂</h3>
              <p className="sub-para">
                While we were taking photos, Suraj Bhaiya gave instructions in
                the most sarcastic way:{" "}
                <strong>
                  "Please keep focus on the route. Kabhi kabhi phone ki photo
                  akhbar (newspaper) mein bhi chhap jaati hai."
                </strong>
              </p>
              <p className="sub-para">
                We all burst out laughing! Point noted, Bhaiya. 😅
              </p>
              <p className="sub-para">
              ...
              <p className="sub-para">
                ...
                here in 1939 to study flora on behalf of the Royal Botanic
                Gardens. While collecting flowers on rocky slopes, she slipped
                and... lost her life. 😢
              </p>
              <p className="sub-para">
                Her sister came searching for her and built a tomb in the
                valley. We didn't see it (it's not on the main trekking route),
                but reading this story made us all emotional.
              </p>
              <p className="sub-para">
                I think emotions are what separate us humans from other species.
                Don't know if that's philosophically correct, but it felt true
                in that moment.
              </p>
              <h3 className="article-subheading"> The Real Trek Begins 🥾</h3>
              <p className="sub-para">
                Around 8:15 AM, we reached a small water crossing. One guide
                from another group was helping people cross. We carefully made
                it across.
              </p>
              <p className="sub-para">
                After walking for a while, we saw{" "}
                <strong>THE main river</strong> of Valley of Flowers. The bridge
                was huge, and the river current was crazy strong. Water was
                crashing against big stones, making this loud,
                scary-but-beautiful sound. I made sure to capture everything in
                my DJI camera!
              </p>
              <p className="sub-para">
                After crossing the bridge, we entered a jungle-type route. One
                side had trees, the other side opened to the valley. We had to
                walk very carefully.
              </p>
              <h3 className="article-subheading">
                {" "}
              ...
              <p className="sub-para">
                Around 11:30, the route became a bit downhill, and I could see
              ...
              <p className="sub-para">Bhai. This was HEAVEN.</p>
              <p className="sub-para">
                In Indian mythology, it's called{" "}
                <strong>"Indra ka Bageecha"</strong> (Garden of Lord Indra). Now
                I understand why.
              </p>
              <p className="sub-para">
                Flowers EVERYWHERE. Every color you can imagine. Mountains on
                all sides. Clouds drifting through the valley. It felt unreal.
              </p>
              <p className="sub-para">
                We searched for our group and found everyone. Suraj Bhaiya said,
                <strong>
              ...
              <p className="sub-para">
                We sat down and had lunch right there in the valley. We asked
                someone to take a photo while we were eating.{" "}
                <strong>
                  This is going to be one of the most amazing photos ever.
                </strong>
              </p>
              <p className="sub-para">
                We're in a UNESCO World Heritage Site! And all of us made sure
                not to throw anything there. We respected the place. Though
                because of taking photos and walking around, we (and all
                tourists) were unintentionally stepping on some plants. Can't be
                helped completely. 😔
              </p>
              <h3 className="article-subheading">
                {" "}
              ...
              <p className="sub-para">
                ...
                know what they were expecting! According to me,{" "}
                <strong>
              ...
              <p className="sub-para">
                ...
                We walked around, saw more flowers, clicked more photos. Pure
                bliss.
              </p>
              <h3 className="article-subheading"> Group Photo Time! 📸</h3>
              <p className="sub-para">
                Around 1:40 PM, Suraj Bhaiya called us back near the big stone.
                We took a{" "}
                <strong>group photo with the Trip My Soul banner</strong> along
                with Suraj Bhaiya.
              </p>
              <p className="sub-para">
                And then I thought -{" "}
              ...
              <p className="sub-para">
                ...
                till count 22, but then she moved the camera slightly right
                because the view was too good. 😂
              </p>
              <p className="sub-para">
                I asked her to record again. This time I did{" "}
                <strong>27 pushups</strong>! Still a good count!
              </p>
              <p className="sub-para">
                Shubham also did pushups. Fitness bhi ho gayi, view bhi enjoy
                kiya. Perfect. 😎
              </p>
              <h3 className="article-subheading">
                {" "}
                The Return Journey & Familiar Faces 👀
              </h3>
              <p className="sub-para">
                We started heading back. Weather was still good, so we were
                walking in T-shirts only.
              </p>
              <p className="sub-para">
                While returning, we didn't take as many photos. But we noticed
                some familiar faces: -{" "}
              ...
              <p className="sub-para">
                Around 2:30 PM, we reached one special point. Special kyun?
                Because{" "}
              ...
              <p className="sub-para">
                But hey, when nature calls, you answer! We emptied our bladders
                and kept moving. 😅
              </p>
              <h3 className="article-subheading">
                {" "}
                Check-Out & The California Professor
              </h3>
              <p className="sub-para">
              ...
              <p className="sub-para">
                ...
                <strong> Snapdragon T-shirt</strong>, so we asked if he works
                there. He said his friend works at Snapdragon. Interesting guy!
              </p>
              <h3 className="article-subheading">
                {" "}
              ...
              <p className="sub-para">
                ...
                evening snacks for us. After eating, me and Shubham went out to
                roam the streets of Ghangaria.
              </p>
              <p className="sub-para">
                We met Reegesh there. And guess who we saw?{" "}
                <strong>That girl from the bus!</strong> The one who created all
                the drama! 😂 Small world.
              </p>
              <p className="sub-para">
                We found a spot where a forest officer was posted. He invited us
                to sit. We heard some amazing stories from him and even recorded
                some of it. But later we deleted the recording because we didn't
                tell him we were recording. We're not bad people, you know! 😅
              </p>
              <p className="sub-para">
                Me, Shubham, and Reegesh chilled for around 45 minutes, then
                explored other parts of Ghangaria.
              </p>
              <p className="sub-para">
                Around 7 PM we came back. Suraj Bhaiya served dinner around 8
            ...
            <div className="content" id="chapter4">
              ...
              <p className="sub-para">
                ...
                km uphill, and come back too. Plus, Gurudwara is open from 6:00
              ...
              <p className="sub-para">
                Now, I learned from yesterday's mistake, so today I was checking
                everything carefully. But guess what?{" "}
                <strong>Saranya made a new mistake!</strong> 😂
              </p>
              <p className="sub-para">
                She{" "}
              ...
              <p className="sub-para">
                ...
                <strong>
                  {" "}
                  "No, because both keys are on the same keychain."
                </strong>{" "}
                And then casually added, "You first complete your trek. In the
                evening we'll see what we can do."
              </p>
              ...
              <p className="sub-para">
                ...
                <strong>lush greenery and flowers. </strong>
                Weather was pleasant but a bit cold. After just 30 minutes, I
                had to wear my jacket.
              </p>
              <p className="sub-para">
                Saranya chose to take a <strong>horse</strong> to go up. The
                rest of us (5 people) decided to walk. This was going to be a
                real challenge!
              </p>
              <p className="sub-para">
              ...
              <p className="sub-para">
                Some of us started questioning life decisions. "Why didn't we
                take the horse?" But then, what's the point of trekking, right?
                😂
              </p>
              <p className="sub-para">
                Around 12:00 PM, we stopped for lunch. Maneesh was ahead of
              ...
              <p className="sub-para">
                ...
                We did it! 14,200 feet! 💪
              </p>
              <p className="sub-para">
                Then we washed our feet and hands and entered the main
                Gurudwara. Bhai, it was{" "}
              ...
              <p className="sub-para">
                Rain had stopped for a while, so we visited the famous
              ...
              <p className="sub-para">
                We waited 15 minutes hoping it would stop. No luck. But it
              ...
              <p className="sub-para">
                ...
                weather was getting worse as time went on.
              </p>
              <p className="sub-para">
                We didn't miss anything, so no regrets!
              </p>
              <p className="sub-para">
              ...
              <h3 className="article-subheading"> The Epic Slip! 😂📹</h3>
              <p className="sub-para">
                After walking for 1.5 hours in the rain, I said to Shubham,
                "Bhai, we've been walking in rain on this downhill slope and no
                one has slipped till now!"
              </p>
              <p className="sub-para">
                <strong>5 minutes later, Shubham slipped.</strong> 😂😂 And it
                got <strong>recorded on camera!</strong> We laughed SO much.
                Classic jinx moment!
              </p>
              <p className="sub-para">
                Aur baarish band hone ka naam hi nahi le rahi thi (the rain just
                wouldn't stop).
              </p>
              <h3 className="article-subheading">
                {" "}
              ...
              <p className="sub-para">
                ...
                <strong>cut the lock </strong>
                and asked me to buy a new one. I was like, "Okay fine, no
                problem. FIRST OPEN THE ROOM!"
              </p>
              <p className="sub-para">
                They cut the lock and finally I could enter. The room was FULL
                of wet clothes. We were literally finding places to tie and hang
                all those wet clothes!
              </p>
              <p className="sub-para">
                We asked Suraj Bhaiya if there's any facility to dry clothes.
                They had one, but were charging too much. So we all decided not
                to use their service. We still had dry clothes for tomorrow,
                plus we'd left some clothes in Pandukeshwar. So once we reach
                there tomorrow, no issues!
              </p>
              <h3 className="article-subheading"> Evening in Ghangaria 🌆</h3>
              <p className="sub-para">
                After 20 minutes, Saranya and Maneesh also arrived. Meanwhile,
              ...
              <p className="sub-para">
                ...
                with us. Otherwise, other shops were asking ₹120-150 for the
                same lock! 😅
              </p>
              <p className="sub-para">
                After that, me, Shubham, and Reegesh explored some other parts
                of Ghangaria.{" "}
                <strong>
                  We're the ones who are always left with energy after finishing
                  the trek.
                </strong>{" "}
                Other people are like "Where is the bed?" 😂
              </p>
              <h3 className="article-subheading">
                {" "}
              ...
              <p className="sub-para">
                After having dinner, we slept around 9:00 PM.
              </p>
              <p className="sub-para">
                Tomorrow, we say goodbye to Ghangaria and start our journey back
                home. 💤
              </p>
            </div>
...
export default ValleyOfFlowersAndHemkundTrek;
